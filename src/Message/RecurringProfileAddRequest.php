 ...
 *
 * https://github.com/thephpleague/omnipay-common/blob/master/UPGRADE.md
 *
 */
class RecurringProfileAddRequest extends AuthorizeRequest {
    ...
    /**
     * @param $data
     * @return \Omnipay\Common\Message\ResponseInterface|\Omnipay\Payflow\Message\Response|RecurringProfileAddResponse
